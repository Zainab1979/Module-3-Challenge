# The csv module is used to read and write tabular data in CSV format.
import csv

# Add a variable to load a file from a path.
# file_to_load = "C:\Users\Zaina\OneDrive\سطح المكتب\Challanging 3-1\python challenge 3\Resources\election_results.csv"
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_list:
        ...
        # 6f: Decision statement to determine the winning county and get its vote count.
